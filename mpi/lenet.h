...
uint8 Predict(LeNet5 *lenet, image input, uint8 count); // Single image prediction
int PredictBatch(LeNet5 *lenet, image *test_data, uint8 *test_label, int total_size); // Batch prediction
